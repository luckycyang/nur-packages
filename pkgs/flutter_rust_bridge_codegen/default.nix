...
pkgs.rustPlatform.buildRustPackage {
  ...
  src = pkgs.fetchFromGitHub {
    ...
    rev = "v2.2.0"; # hash of the commit
    sha256 = "sha256-I1f1Dye9DH5/cNYZhPPXcNZ1gG7a0F4Yj9G2SIe1aJ8="; # optained SHA-256 with nix-prefetch-url --unpack https://github.com/fzyzcjy/flutter_rust_bridge/archive/v2.0.0-dev.31.tar.gz
  };
  cargoSha256 = "sha256-viHZjZ2cItQNbHxKyf9pPZ0jbNfdd3t0KKvqQxvwlSs="; # pkgs.lib.fakeSha256; # set it to 'lib.fakeSha256' and run nix (develop/build). replace the sha from the error message.
